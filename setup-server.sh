...
docker exec nutrition-server bash -c '
# 1. Ordner erstellen
...
SECRET_KEY = "nutrition-super-secret-key-12345"
ALGORITHM = "HS256"
...
# 12. Server starten (im Hintergrund, detached from shell)
nohup python -m uvicorn main:app --host 0.0.0.0 --port 8000 --app-dir /app > /app/logs/server.log 2>&1 &
sleep 2
echo "Server gestartet auf Port 8000"
'
